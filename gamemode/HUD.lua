function hud() -- Consider functions like a cyber button, and everything INSIDE the function turns on when this cyber button is pressed.
    ...
    draw.SimpleText("Armor: "..client:Armor().."%","DermaDefaultBold",35,ScrH()-65,Color(5,150,255,255),0,0)
    ...
    draw.RoundedBox(0, 25, ScrH()-130, 200, 20, Color(25,  25, 25, 150))
    draw.RoundedBox(0, ScrW()-215, ScrH()-60, 200, 40, Color(25,  25, 25, 150))
    draw.SimpleText("Clock: "..tostring(os.date()),"DermaDefaultBold",ScrW()-200,ScrH()-50,Color(220,220,220,255),0,0)
    draw.SimpleText("Ping: "..client:Ping(),"DermaDefaultBold",35,ScrH()-128,Color(250,230,0,255),0,0)
    surface.SetDrawColor(0,0,255,200)
    surface.DrawOutlinedRect( 25, ScrH()-130,200,20)
    ...
    local money = LocalPlayer():GetNWInt("Money", 0)
    draw.SimpleText("Money: "..money,"DermaDefaultBold",120,ScrH()-128,Color(0,0,255,255),0,0)
end 
